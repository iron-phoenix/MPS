...
public class QueriesGenerated {
  ...
  public static void mappingScript_CodeBlock_1812980409690698650(final MappingScriptContext _context) {
    ...
    for (SNode constructorDeclaration : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.ConstructorDeclaration"))) {
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(constructorDeclaration, "body", true), "statement", true)).insertElement(0, _quotation_createNode_x583g4_a0a0a5a3(context, SPropertyOperations.getString(constructorDeclaration, "nestedName")));
    }
    for (SNode conctructor : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.ClassCreator"))) {
      if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(conctructor), "jetbrains.mps.baseLanguage.structure.GenericNewExpression") && ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), null)).contains(SLinkOperations.getTarget(conctructor, "baseMethodDeclaration", false))) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(conctructor), _quotation_createNode_x583g4_a0a0a0a6a3(context, SPropertyOperations.getString(SLinkOperations.getTarget(conctructor, "baseMethodDeclaration", false), "nestedName"), SNodeOperations.getParent(conctructor)));
      }
    }
    ...
    for (SNode methodDeclaration : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.MethodDeclaration"))) {
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(methodDeclaration, "body", true), "statement", true)).insertElement(0, _quotation_createNode_x583g4_a0a0a8a3(context, SPropertyOperations.getString(methodDeclaration, "name")));
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.StaticMethodCall"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a1a01a3(SNodeOperations.getParent(call), context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a0b0k0d(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), SNodeOperations.getParent(call)));
      }
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.LocalMethodCall"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a1a21a3(call, context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a0b0m0d(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), call));
      }
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a1a51a3(SNodeOperations.getParent(call), context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a0b0p0d(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), SNodeOperations.getParent(call)));
      }
    }
  }
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a5a3(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a6a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a8a3(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a01a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0k0d(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a21a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0m0d(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a51a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0p0d(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
