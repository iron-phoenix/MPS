...
public class QueriesGenerated {
  ...
  public static void mappingScript_CodeBlock_1812980409690698650(final MappingScriptContext _context) {
    ...
    SNode context = _quotation_createNode_x583g4_a0d0b(String.valueOf(SPropertyOperations.getBoolean(logFormat, "time")));

    for (SNode constructorDeclaration : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.ConstructorDeclaration"))) {
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(constructorDeclaration, "body", true), "statement", true)).insertElement(0, _quotation_createNode_x583g4_a0a0a5a1(context, SPropertyOperations.getString(constructorDeclaration, "nestedName")));
    }
    for (SNode conctructor : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.ClassCreator"))) {
      if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(conctructor), "jetbrains.mps.baseLanguage.structure.GenericNewExpression") && ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), null)).contains(SLinkOperations.getTarget(conctructor, "baseMethodDeclaration", false))) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(conctructor), _quotation_createNode_x583g4_a0a0a0a6a1(context, SPropertyOperations.getString(SLinkOperations.getTarget(conctructor, "baseMethodDeclaration", false), "nestedName"), SNodeOperations.getParent(conctructor)));
      }
    }
    ...
    for (SNode methodDeclaration : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.MethodDeclaration"))) {
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(methodDeclaration, "body", true), "statement", true)).insertElement(0, _quotation_createNode_x583g4_a0a0a8a1(context, SPropertyOperations.getString(methodDeclaration, "name")));
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.StaticMethodCall"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a1a01a1(SNodeOperations.getParent(call), context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a0b0k0b(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), SNodeOperations.getParent(call)));
      }
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.LocalMethodCall"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a1a21a1(call, context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(call, _quotation_createNode_x583g4_a0a0a0b0m0b(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), call));
      }
    }
    ...
    for (SNode call : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"))) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "returnType", true), "jetbrains.mps.baseLanguage.structure.VoidType")) {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a1a51a1(SNodeOperations.getParent(call), context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name")));
      } else {
        SNodeOperations.replaceWithAnother(SNodeOperations.getParent(call), _quotation_createNode_x583g4_a0a0a0b0p0b(context, SPropertyOperations.getString(SLinkOperations.getTarget(call, "baseMethodDeclaration", false), "name"), SNodeOperations.getParent(call)));
      }
    }
  }
  ...
  public static void mappingScript_CodeBlock_1180016765150195565(final MappingScriptContext _context) {
    ...
    SNode logFormat = SLinkOperations.getTarget(ListSequence.fromList(SModelOperations.getRoots(_context.getModel(), "tracer.structure.Log")).first(), "format", true);
    SNode context = _quotation_createNode_x583g4_a0d0c(String.valueOf(SPropertyOperations.getBoolean(logFormat, "time")));
    ...
    for (SNode exp : ListSequence.fromList(mods)) {
      if (SNodeOperations.isInstanceOf(exp, "jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression")) {
        ...
        SLinkOperations.setTarget(expr, "rValue", _quotation_createNode_x583g4_a0b0a0i0c(context, Tracer.getVariableName(SLinkOperations.getTarget(expr, "lValue", true)), SLinkOperations.getTarget(expr, "rValue", true), SPropertyOperations.getString(SNodeOperations.getConceptDeclaration(expr), "conceptAlias")), true);
        ...
        SNodeOperations.replaceWithAnother(expr, _quotation_createNode_x583g4_a0a1a0a0i0c(context, Tracer.getVariableName(SLinkOperations.getTarget(expr, "expression", true)), expr, SPropertyOperations.getString(SNodeOperations.getConceptDeclaration(expr), "conceptAlias")));
      }
    }
  }
  ...
  public static void mappingScript_CodeBlock_5504672902128771601(final MappingScriptContext _context) {
    ...
    SNode logFormat = SLinkOperations.getTarget(ListSequence.fromList(SModelOperations.getRoots(_context.getModel(), "tracer.structure.Log")).first(), "format", true);
    SNode context = _quotation_createNode_x583g4_a0d0d(String.valueOf(SPropertyOperations.getBoolean(logFormat, "time")));
    ...
    for (SNode var : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.VariableReference"))) {
      if (!(SNodeOperations.isInstanceOf(SNodeOperations.getParent(var), "jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression") || (SNodeOperations.isInstanceOf(SNodeOperations.getParent(var), "jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation") && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(var), "jetbrains.mps.baseLanguage.structure.UnaryMinus")))) && ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), null)).contains(SLinkOperations.getTarget(var, "variableDeclaration", false))) {
        SNodeOperations.replaceWithAnother(var, _quotation_createNode_x583g4_a0a0a0a5a3(context, Tracer.getVariableName(var), var));
      }
    }
    ...
    for (SNode assignment : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression"))) {
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(assignment, "rValue", true), "jetbrains.mps.baseLanguage.structure.VariableReference") && ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), null)).contains(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(assignment, "rValue", true), "jetbrains.mps.baseLanguage.structure.VariableReference"), "variableDeclaration", false))) {
        SNodeOperations.replaceWithAnother(SLinkOperations.getTarget(assignment, "rValue", true), _quotation_createNode_x583g4_a0a0a0a7a3(context, Tracer.getVariableName(SLinkOperations.getTarget(assignment, "rValue", true)), SLinkOperations.getTarget(assignment, "rValue", true)));
      }
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(assignment, "rValue", true), "jetbrains.mps.baseLanguage.structure.DotExpression") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(assignment, "rValue", true), "jetbrains.mps.baseLanguage.structure.DotExpression"), "operation", true), "jetbrains.mps.baseLanguage.structure.FieldReferenceOperation") && ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), null)).contains(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(assignment, "rValue", true), "jetbrains.mps.baseLanguage.structure.DotExpression"), "operation", true), "jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"), "fieldDeclaration", false))) {
        SNodeOperations.replaceWithAnother(SLinkOperations.getTarget(assignment, "rValue", true), _quotation_createNode_x583g4_a0a0a1a7a3(context, Tracer.getVariableName(SLinkOperations.getTarget(assignment, "rValue", true)), SLinkOperations.getTarget(assignment, "rValue", true)));
      }
    }
    ...
    for (SNode field : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"))) {
      ...
      SNodeOperations.replaceWithAnother(SNodeOperations.getParent(field), _quotation_createNode_x583g4_a0a1a9a3(context, Tracer.getVariableName(SNodeOperations.as(SNodeOperations.getParent(field), "jetbrains.mps.baseLanguage.structure.Expression")), SNodeOperations.getParent(field)));
    }
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a5a1(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    ...
    quotedNode_4.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", quotedNode_4, facade.createModelReference("r:a2c5f272-20b1-463c-ad12-97c6ae9bbb6a(tracer.runtime)"), facade.createNodeId("1812980409692841541")));
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a6a1(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
    ...
    quotedNode_4 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StaticMethodCall", null, null, false);
    quotedNode_4.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", quotedNode_4, facade.createModelReference("r:a2c5f272-20b1-463c-ad12-97c6ae9bbb6a(tracer.runtime)"), facade.createNodeId("1812980409692846239")));
    quotedNode_4.setReference("classConcept", SReference.create("classConcept", quotedNode_4, facade.createModelReference("r:a2c5f272-20b1-463c-ad12-97c6ae9bbb6a(tracer.runtime)"), facade.createNodeId("1180016765149615085")));
    quotedNode_5 = (SNode) parameter_1;
    if (quotedNode_5 != null) {
      quotedNode_4.addChild("actualArgument", HUtil.copyIfNecessary(quotedNode_5));
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a8a1(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a01a1(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0k0b(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a21a1(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0m0b(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a51a1(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0b0p0b(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0b0a0i0c(Object parameter_1, Object parameter_2, Object parameter_3, Object parameter_4) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
    SNode quotedNode_7 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a1a0a0i0c(Object parameter_1, Object parameter_2, Object parameter_3, Object parameter_4) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
    SNode quotedNode_7 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a5a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a7a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a1a7a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_x583g4_a0a1a9a3(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
