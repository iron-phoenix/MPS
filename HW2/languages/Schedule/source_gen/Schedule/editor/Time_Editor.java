...
public class Time_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9up4zz_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_9up4zz_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_9up4zz_b0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_9up4zz_c0(editorContext, node));
    return editorCell;
  }

  private EditorCell createProperty_9up4zz_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_9up4zz_b0(EditorContext editorContext, SNode node) {
